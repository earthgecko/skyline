/*
This is the SQL script to update Skyline from v4.0.0 to v5.0.0
*/
...
# Added unique constraint on metric but moved to
# v5.0.0.supplemental.metric.unique-constraint.sql to be run individually so
# that if is fails it does not cause the main v5.0.0 SQL update to fail.
