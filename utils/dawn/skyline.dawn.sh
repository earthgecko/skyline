...
MYSQL_ROOT_PASSWORD="XXXXXXXXXXXXXXX"     # The MySQL root user password
MYSQL_SKYLINE_PASSWORD="XXXXXXXXXXXXXXX"  # The Skyline DB user password
REDIS_PASSWORD="XXXXXXXXXXXXXXX"       # The Redis password
