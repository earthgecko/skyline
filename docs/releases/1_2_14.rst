...
.. code-block:: bash
    ...
    cat /opt/skyline/github/skyline/requirements.txt | grep -v "luminol\|redis" > /tmp/requirements.txt
    ...
    # Update redis-py
    cat /opt/skyline/github/skyline/requirements.txt | grep "redis" > /tmp/redis.requirements.txt
