# -*- coding: utf-8 -*-
#
# skyline documentation build configuration file, created by
# sphinx-quickstart on Sat Jan 16 11:40:02 2016.
#
...
sys.path.insert(0, os.path.abspath('../skyline'))
...
autodoc_mock_imports = ['skyline.settings', 'daemon']
...
project = u'Skyline'
copyright = u'2013-2014, Etsy Inc; 2015, Abe Stanway; 2015-2024, Gary Wilson'
...
exclude_patterns = ['_build', 'agent.py']
...
latex_documents = [
    (master_doc, 'skyline.tex', u'Skyline Documentation',
     u'etsy, astanway, earthgecko', 'skyline-project', 'manual'),
]
...
man_pages = [
    (master_doc, 'skyline', u'skyline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'skyline', u'skyline Documentation',
     author, 'skyline-project', 'Anomaly detection.',
     'Miscellaneous'),
]
