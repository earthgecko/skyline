...
changepoints by design, only significant changepoints.  But it scores are better
than expected, it is places 6th overall.
...
The below graphs show the results of m66 run with the default
...
.. figure:: ../images/custom_algorithms/m66/m66.seasonal.A.png
    :alt: m66 seasonal time series A
    
    *m66.seasonal.A - runtime: 0.197 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.seasonal.B.png
    :alt: m66 seasonal time series B
    
    *m66.seasonal.B - runtime: 0.087 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.seasonal.C.png
    :alt: m66 seasonal time series C
    
    *m66.seasonal.C - runtime: 0.081 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.seasonal.D.png
    :alt: m66 seasonal time series D
    
    *m66.seasonal.D - runtime: 0.394 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.seasonal_unstable.A.png
    :alt: m66 seasonal_unstable time series A
    
    *m66.seasonal_unstable.A - runtime: 0.019 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.seasonal_unstable.B.png
    :alt: m66 seasonal_unstable time series B
    
    *m66.seasonal_unstable.B - runtime: 0.014 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.stable.A.png
    :alt: m66 stable time series A
    
    *m66.stable.A - runtime: 0.087 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.stable.B.png
    :alt: m66 stable time series B
    
    *m66.stable.B - runtime: 0.013 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.stable.E.png
    :alt: m66 stable time series E
    
    *m66.stable.E - runtime: 0.095 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.stable.F.png
    :alt: m66 stable time series F
    
    *m66.stable.F - runtime: 0.023 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.unstable.A.png
    :alt: m66 unstable time series A
    
    *m66.unstable.A - runtime: 0.086 seconds*

.. figure:: ../images/custom_algorithms/m66/m66.unstable.B.png
    :alt: m66 unstable time series B
    
    *m66.unstable.B - runtime: 0.092 seconds*

Testing m66 with TCPDBench
==========================

   "If you want to climb the mountain, you must do all the hard things and climb it."

   -- Kukuczka

Apart from some lacking docs and dependencies bugs with TCPDBench, got there in
the end.
