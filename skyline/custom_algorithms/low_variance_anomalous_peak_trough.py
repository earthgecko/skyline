...
def low_variance_anomalous_peak_trough(current_skyline_app, parent_pid, timeseries, algorithm_parameters):
    ...
    try:
        ...
        if analyse_peaks_only and peak_analysis:
            ...
            results['number_of_peaks'] = number_of_peaks
            results['peak_values_mean'] = peak_values_mean
            results['peak_values_median'] = peak_values_median
            results['peak_values_stdDev'] = peak_values_stdDev
            results['mean_threshold'] = mean_threshold
            results['median_threshold'] = median_threshold
            results['all_peak_values_mean'] = all_peak_values_mean
            results['all_peak_values_median'] = all_peak_values_median
            results['all_peak_values_stdDev'] = all_peak_values_stdDev
            results['all_peak_median_threshold'] = all_peak_median_threshold
